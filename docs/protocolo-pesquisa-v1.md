...
3. **Conhecimento específico**  
   De três a cinco itens alinhados ao objetivo da oficina. Esses itens ainda não foram definidos e não aparecem na interface 1.5.0.
...
- [ ] Schema 1.5.0 aplicado em ambiente de teste.
